...
pv.id,
COALESCE(pv.oil1,0) + COALESCE(pv.oil2,0) + COALESCE(pv.oil3,0) + COALESCE(pv.oil4,0) + COALESCE(pv.oil5,0) + COALESCE(pv.oil6,0) +
COALESCE(pv.oil7,0) + COALESCE(pv.oil8,0) + COALESCE(pv.oil9,0) + COALESCE(pv.oil10,0) + COALESCE(pv.oil11,0) as "oil",

COALESCE(pv.water1,0) + COALESCE(pv.water2,0) + COALESCE(pv.water3,0) + COALESCE(pv.water4,0) + COALESCE(pv.water5,0) + COALESCE(pv.water6,0) +
COALESCE(pv.water7,0) + COALESCE(pv.water8,0) + COALESCE(pv.water9,0) + COALESCE(pv.water10,0) + COALESCE(pv.water11,0) as "water",

COALESCE(pv.gas1,0) + COALESCE(pv.gas2,0) + COALESCE(pv.gas3,0) + COALESCE(pv.gas4,0) + COALESCE(pv.gas5,0) + COALESCE(pv.gas6,0) +
COALESCE(pv.gas7,0) + COALESCE(pv.gas8,0) + COALESCE(pv.gas9,0) + COALESCE(pv.gas10,0) + COALESCE(pv.gas11,0) as "gas",
...
WHERE
pv1.id = '9ac5b719-93ff-410a-b1d5-1d538c89d888') pv
