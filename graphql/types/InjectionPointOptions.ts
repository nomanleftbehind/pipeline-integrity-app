...
export const totalPipelineFlowRawQuery = async (id: (string | null)[], ctx: Context) => {
  const result = await ctx.prisma.$queryRaw<NexusGenObjects['PipelineFlow'][]>`
  SELECT * FROM get_last_join('''06c1210d-b560-423e-9c05-fd0e5e1273a7'',''c9518b99-067b-4a38-837f-27846697728a''');
  `
  console.log('Prisma join: ', `SELECT * FROM get_last_join('''06c1210d-b560-423e-9c05-fd0e5e1273a7'',''c9518b99-067b-4a38-837f-27846697728a''');`);
