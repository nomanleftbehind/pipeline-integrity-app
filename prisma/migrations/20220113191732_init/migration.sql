...
-- CreateEnum
CREATE TYPE "limitingSpec" AS ENUM ('ANSI 150', 'ANSI 300', 'ANSI 600');

-- CreateEnum
CREATE TYPE "environmentProximityTo" AS ENUM ('WB1', 'WB3', 'WB4', 'WB5', 'WC1', 'WC2', 'WC3', 'WC4');

-- CreateEnum
CREATE TYPE "geotechnicalFacingS1" AS ENUM ('N', 'NE', 'E', 'SE', 'S', 'SW', 'W', 'NW');
...
CREATE TABLE "Risk" (
    ...
    "geotechnicalFacingS2" "geotechnicalFacingS1",
