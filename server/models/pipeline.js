...
const validators = {
  ...
  from_to: "^(\\d{2}-\\d{2}-\\d{3}-\\d{2}W\\d{1})$",
  from_to_feature: ['Blind end', 'Pipeline', 'Compressor station', 'Battery', 'Well', 'Satellite', 'Injection plant', 'Gas processing plant', 'Meter station', 'Storage tank', 'Pump station'],
